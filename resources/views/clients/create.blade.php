...
@section('content')
    <div class="flex justify-center ">
        ...
        <div class="block p-6 rounded-lg shadow-lg bg-white max-w-md  justify-center">
            <div class="block
            w-full
            px-3
            py-1.5
            ...
            <div class="form-group mb-6">
                ...
                <input name="amount" value="{{ old('amount') }}"type="number" class="form-control block
                w-full
                px-3
                py-1.5
                text-base
            ...
            <div class="form-group mb-6">
                ...
                <input name="payment_method" value="{{ old('payment_method') }}" type="text" class="form-control block
                w-full
                px-3
                py-1.5
                text-base
