...
<div class="flex justify-center">
    <div class="block p-6 rounded-lg shadow-lg bg-white max-w-md">
        ...
        focus:text-gray-700 focus:bg-white focus:border-blue-600 focus:outline-none">
            <h3>Make Payment for {{ $client->first_name }}</h3>
        </div>
        @if ($errors->any())
        ...
        @endif
        <form action=" {{ route('payment.store', $client->id) }} " method="POST">
            @csrf
          <div class="grid grid-cols-2 gap-4">
            ...
            <div class="form-group mb-6">
              ...
              <input name="amount" value="{{old('amount')}}" type="number" min="1" max="10000"class="form-control
                block
                w-full
                px-3
                py-1.5
          ...
          <div class="form-group mb-6">
            ...
            <input  name="received_by" value="{{old('received_by')}}"type="text" class="form-control block
              w-full
              px-3
              py-1.5
              text-base
          ...
          <div class="form-group mb-6">
            ...
            <input name="payment_mode" value="{{old('payment_method')}}"type="text" class="form-control block
              w-full
              px-3
              py-1.5
              text-base
